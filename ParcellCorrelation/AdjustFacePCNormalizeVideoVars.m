%% This code adjusts the facemap proc outputs for all sessions within a directory
%flipping the face whisker PC1 signs based on skewness sign 
%and normalizes whisker PC1, face PC1 and pupil
% written by SL 2021
clear all; close all ; 
outputFolder='W:\GRABS_Data\AnalyzedLocalPharmacology';%main directory 
MiceAnalyze=[{'cn1\'},{'cn2\'},{'cn3\'}]; %names of mouse folders 

%% loop through each mouse folder and the session folders and get proc outputs 
