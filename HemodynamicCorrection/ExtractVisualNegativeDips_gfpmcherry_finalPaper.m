%% Figure S3, hemodynamics. This script calculates peak of negative flourescence dips around a particular event (such as visual stim for GRABs mice or airpuff for GFP control mice)
%written by Sweyta Lohani 2020
close all; clear all
%% user defined folder inputs
figuresFolder='F:\GRABS_Data\Analyzed_SVDMethodPatch14\Figures\FiguresRevisionsSep2022\FigureS3\VisualStimDipMethodComparison\GFPMcherryMice';%where figures and output will be saved
