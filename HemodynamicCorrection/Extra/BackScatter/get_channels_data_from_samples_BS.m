function [channels_data,wheelOn,wheelOff,h1] = get_channels_data_from_samples_BS(data, channels,sCFG,fsspike2)
...
for ni = 1:length(names)
    switch names{ni}
        ...
        case 'BS1'
            channels_data.BS1=(data(:,channels.BS1)-nanmin(data(:,channels.BS1))>0.5);
        case 'BS2'
            channels_data.BS2=(data(:,channels.BS2)-nanmin(data(:,channels.BS2))>0.5);
