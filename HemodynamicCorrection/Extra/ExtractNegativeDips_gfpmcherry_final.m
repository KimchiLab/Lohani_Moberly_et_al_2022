...
figuresFolder='F:\GRABS_Data\Analyzed_SVDMethodPatch14\Figures\FiguresRevisionsFeb2022\Hemodynamics\VisualStimDipMethodComparison\GFPMcherryMice';%where figures and output will be saved
...
[~,finalData.vis.data.stats.bluegreenComp.uncorrected]=ttest(data(1,:),data(2,:));
figure2=figure;
