...
% figuresFolder='F:\GRABS_Data\Analyzed_SVDMethodPatch14\Figures\FiguresRevisionsSep2022\FigureS3\VisualStimDipMethodComparison\DualMice';%where figures and output will be saved

inputFolder='W:\GRABS_Data\Analyzed_SVDMethodPatch14\Raw and UVPix outputs for dual mice and egfp\GFP';%where pixelwise regressed and uncorrected data are
inputFolder1='W:\GRABS_Data\Analyzed_SVDMethodPatch14\GFP';%where spatial SVd data and smrx data are
...
figuresFolder='F:\GRABS_Data\Analyzed_SVDMethodPatch14\Figures\FiguresRevisionsSep2022\FigureS3\VisualStimDipMethodComparison\GFPAirpuff';%where figures and output will be saved
